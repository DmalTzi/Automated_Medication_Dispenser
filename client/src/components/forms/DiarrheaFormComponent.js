...
const DiarrheaFormComponent = () => {
    ...
    // symptom
    const symptomOptions = ["ท้องอืด ท้องเฟ้อ","จุกเสียด"];
            ...
            <div className="mycontainer mt-5 pb-5">
                <form onSubmit={submitForm}>
                    <div className="container-form mb-5">
                        ...
                        <div className="one-form">
                            <label htmlFor="">มีประวัติการแพ้ไซเมทิโคนหรือไม่</label>
                            <Dropdown
                        ...
                        <div className="one-form">
                            <label htmlFor="">เป็นโรคไทรอยด์ ภาวะฟีนิลคีโตนในปัสสาวะ <br/>มีการตั้งครรภ์หรือไม่</label>
                            <Dropdown
                        ...
                        <div className="one-form">
                            <label htmlFor="">ประวัติการรับประทานยา</label>
                            <Dropdown
                        ...
                        <div className="one-form">
                            ...
                            <ul>
                                <li className="alerts">เคี้ยวให้ละเอียดก่อนกลืน</li>
                                <li className="alerts">ไม่ควรใช้ยานี้เกินวันละ 6 เม็ด</li>
...
export default DiarrheaFormComponent;